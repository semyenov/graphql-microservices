...
> = {
  activateProduct?: Resolver<
    ResolversTypes['Product'],
    ParentType,
    ContextType,
    RequireFields<MutationActivateProductArgs, 'id'>
  >;
  bulkUpdateStock?: Resolver<
    Array<ResolversTypes['Product']>,
    ParentType,
    ContextType,
    RequireFields<MutationBulkUpdateStockArgs, 'updates'>
  >;
  ...
  >;
  deactivateProduct?: Resolver<
    ResolversTypes['Product'],
    ParentType,
    ContextType,
    RequireFields<MutationDeactivateProductArgs, 'id'>
  >;
  ...
  updateStock?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateStockArgs, 'id' | 'quantity'>
  >;
};
...
export type ProductsPageResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['ProductsPage'] = ResolversParentTypes['ProductsPage'],
> = {
...
> = {
  ...
  >;
  productBySku?: Resolver<
    Maybe<ResolversTypes['Product']>,
    ParentType,
    ContextType,
    RequireFields<QueryProductBySkuArgs, 'sku'>
  >;
  products?: Resolver<
    ResolversTypes['ProductsPage'],
    ParentType,
    ContextType,
  ...
  searchProducts?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerySearchProductsArgs, 'limit' | 'query'>
  >;
};
...
> = {
  productCreated?: SubscriptionResolver<
    ...
    ContextType
  >;
  productDeactivated?: SubscriptionResolver<
    ResolversTypes['Product'],
    'productDeactivated',
    ParentType,
    ContextType
  >;
  productStockChanged?: SubscriptionResolver<
    ResolversTypes['Product'],
    'productStockChanged',
    ParentType,
    ContextType,
    Partial<SubscriptionProductStockChangedArgs>
  >;
  productUpdated?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    Partial<SubscriptionProductUpdatedArgs>
  >;
};
