...
h.logarithm = h.log = function (e) {
  ...
  if (
    ...
    do
      if (
        ((u += 10), (o = B(this, u)), (t = n ? ue(l, u + 10) : B(e, u)), (c = k(o, t, u, 1)), !s)
      ) {
...
h.minus = h.sub = function (e) {
  ...
  if (((f = this.d), (d = e.d), (u = v.precision), (c = v.rounding), !f[0] || !d[0])) {
    if (d[0]) e.s = -e.s;
    else if (f[0]) e = new v(this);
    else return new v(c === 3 ? -0 : 0);
    return w ? p(e, u, c) : e;
  }
  if (((i = R(e.e / m)), (l = R(this.e / m)), (f = f.slice()), (s = l - i), s)) {
    for (
      a = s < 0,
...
h.plus = h.add = function (e) {
  ...
  if (((f = this.d), (l = e.d), (u = d.precision), (c = d.rounding), !f[0] || !l[0]))
    return l[0] || (e = new d(this)), w ? p(e, u, c) : e;
  if (((s = R(this.e / m)), (t = R(e.e / m)), (f = f.slice()), (r = s - t), r)) {
    for (
...
h.precision = h.sd = function (e) {
  ...
  return this.d ? ((n = $e(this.d)), e && this.e + 1 > n && (n = this.e + 1)) : (n = NaN), n;
};
h.round = function () {
...
h.squareRoot = h.sqrt = function () {
  var e,
    ...
    f = this.s,
    l = this.constructor;
  if (f !== 1 || !u || !u[0]) return new l(!f || (f < 0 && (!u || u[0])) ? NaN : u ? this : 1 / 0);
  for (
    w = !1,
      f = Math.sqrt(+this),
      f == 0 || f == 1 / 0
...
function Ge(e) {
  ...
  function r(s) {
    ...
    if (((c = typeof s), c === 'number')) {
      ...
      if ((s < 0 ? ((s = -s), (this.s = -1)) : (this.s = 1), s === ~~s && s < 1e7)) {
    ...
    if (c === 'bigint')
      return s < 0 ? ((s = -s), (this.s = -1)) : (this.s = 1), re(this, s.toString());
    throw Error($ + s);
  }
  if (
    ((r.prototype = h),
